...
class LayerParam : public Layer {
 public:
  ...
  // FP16 weight support
  base::Status set_weight_fp16(int32_t idx, const std::vector<int32_t>& dims, const void* weight_ptr,
                               base::DeviceType device_type = base::DeviceType::kDeviceUnknown);

  // Control whether to keep FP16 weights on GPU (for pure FP16 compute path)
  void set_keep_fp16_weights(bool keep_fp16) { keep_fp16_weights_ = keep_fp16; }
  bool get_keep_fp16_weights() const { return keep_fp16_weights_; }
 ...
 protected:
  ...
  bool keep_fp16_weights_ = false;  // If true, keep FP16 weights on GPU instead of converting to FP32
