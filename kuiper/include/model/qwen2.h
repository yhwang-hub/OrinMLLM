...
class Qwen2Model : public Model {
 ...
 private:
  ...
  // Single token attention operations (for decode phase)
  ...
  // Fused feed_forward: combines W1+W3+SwiGLU into a single kernel for decode phase
 ...
 private:
  ...
  // Fused FFN optimization: combines W1+W3+SwiGLU into single kernel
